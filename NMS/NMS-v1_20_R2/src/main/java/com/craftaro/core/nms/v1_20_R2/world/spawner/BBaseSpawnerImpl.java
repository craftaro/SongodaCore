package com.craftaro.core.nms.v1_20_R2.world.spawner;
                ...
                if (worldServer.noCollision(optional.get().getAABB(d0, d1, d2))) {
                    label114:
                    {
                        ...
                        if (mobSpawnerData.getCustomSpawnRules().isPresent()) {
                            ...
                            if (!mobSpawnerDataA.blockLightLimit().isValueInRange(worldServer.getBrightness(LightLayer.BLOCK, blockposition1)) || !mobSpawnerDataA.skyLightLimit().isValueInRange(worldServer.getBrightness(LightLayer.SKY, blockposition1))) {
                                break label114;
                            }
                        } else if (!SpawnPlacements.checkSpawnRules(optional.get(), worldServer, MobSpawnType.SPAWNER, blockposition1, worldServer.getRandom())) {
                            break label114;
                        }
