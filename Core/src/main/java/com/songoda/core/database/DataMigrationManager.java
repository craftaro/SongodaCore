...
public class DataMigrationManager {
    ...
    private final DataManager dataManagerAbstract;

    public DataMigrationManager(DatabaseConnector databaseConnector, DataManager dataManagerAbstract, DataMigration... migrations) {
